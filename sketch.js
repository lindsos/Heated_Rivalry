...
function draw() {
  ...
  //episode 2
  link2.position(250, 275);
  link2.style("font-size", "10px");
  link2.style(textAlign(LEFT));
  link2.style("color", "black");
  link2.style("z-index", "5");
  ...
  //episode 3
  link3.position(475, 275);
  link3.style("font-size", "10px");
  link3.style(textAlign(LEFT));
  link3.style("color", "black");
  link3.style("z-index", "5");
  ...
  //episode 4
  link4.position(25, 465);
  link4.style("font-size", "10px");
  link4.style(textAlign(LEFT));
  link4.style("color", "black");
  link4.style("z-index", "5");
  ...
  //episode 5
  link5.position(250, 465);
  link5.style("font-size", "10px");
  link5.style(textAlign(LEFT));
  link5.style("color", "black");
  link5.style("z-index", "5");
  ...
  //episode 6
  link6.position(475, 465);
  link6.style("font-size", "10px");
  link6.style(textAlign(LEFT));
  link6.style("color", "black");
  link6.style("z-index", "5");
